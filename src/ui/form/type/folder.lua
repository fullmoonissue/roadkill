    ...
    if getPathValue() == '' then
        labelFeedbackLocation:set_text(
            string.format(
                ...
                i18n.formItemTypeFolder.error.pathRequired
            )
        )
